...
public class BaseTrainController : MonoBehaviour , IRecyle, IBaseTrainController{
    ...
    public TrainVO StaticData
    {
        ...
        {
            _trainData = value;
            ITrainComponent[] componentsArray = gameObject.GetComponentsInChildren<ITrainComponent>();
            for (int i = 0; i < componentsArray.Length; i++)
            {
                componentsArray[i].MainController = this;
            }
        }
    }
